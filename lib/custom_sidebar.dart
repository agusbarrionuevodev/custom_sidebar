...
class _CustomSidebarState extends State<CustomSidebar> {
  ...
  Widget build(BuildContext context) {
    final double expandedWidth = widget.width ?? MediaQuery
        .of(context)
        .size
        .width * 0.2;
    ...
    final responsive = MediaQuery
        .sizeOf(context)
        .width > widget.changeToResponsiveWidth;
      ...
      body: responsive ? Row(
        children: <Widget>[
          AnimatedContainer(
            ...
            width: _isExpanded ? expandedWidth : widget.collapsedWidth ?? 60,
            color: widget.sidebarBackgroundColor ?? Colors.blue,
            child: Column(
              children: [
                expansionButton(),
                if (_isExpanded) widget.header ?? const SizedBox.shrink(),
                Expanded(
                  child: ListView(
                ...
                if (_isExpanded) widget.footer ?? const SizedBox.shrink(),
              ],
            ),
          ),
